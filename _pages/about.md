...
## Recent Highlights  
* [**March,2025**] - Our paper titled "COLOR: A compositional linear operation-based representation of protein sequences for identification of monomer contributions to properties" is accepted at [MLGenX workshop in ICLR 2025](https://openreview.net/forum?id=4JGIrEGfYz). 
* [**Feb,2025**] - Submited our paper on surface-EMG based silent-speech recognition using LLMs to ACL.
* [**Jan,2025**] - Our novel eXplainable AI (XAI) method, named COLOR, developed to estimate contribution of each monomer in the primary sequence is now online on [arXiv](https://arxiv.org/pdf/2501.06371).
