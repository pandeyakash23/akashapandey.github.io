...
Currently, I am working on accelerating the mutation-based primary sequence optimization in proteins using by taking into account the contribution of each monomers in the sequence. In the past, I have worked on explainable AI models for proteins to understand the contribution of each monomers in the sequence, predict protein's dynamic behavior and mechanical properties.  
